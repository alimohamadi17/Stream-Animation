    ...
    return (
        <React.Fragment>
            ...
            <div className='PrivacyPolicy'>
                <h1 className='Privacy'>WEBSITE PRIVACY POLICY</h1>
                Last updated September 24th, 2021 <br />


                <b>INTRODUCTION</b>  <br />

                <p className='P-Privacy'>
                    Ario Entertainment respects the privacy of our users. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website <a href='http://www.arioentertainment.com'>www.arioentertainment.com</a> [and our mobile application], including any other media form, media channel, mobile website, or mobile application related or connected thereto. Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the site.
                    <br /><br />
                    ...
                    <b>COLLECTION OF YOUR INFORMATION</b><br /><br />
                    ...
                    <br /><br />
                    <b>Derivative Data</b> <br /><br />
                    Information our servers automatically collect when you access the Site, such as your IP address, your browser type, your operating system, your access times, and the pages you have viewed directly before and after accessing the Site. [If you are using our mobile application, this information may also include your device name and type, your operating system, your phone number, your country, your likes and replies to a post, and other interactions with the application and other users via server log files, as well as any other information you choose to provide.]<br /><br />

                    <b>Facebook Permissions</b><br /><br />
                    The Site [and our mobile application] may by default access your <a href="https://www.facebook.com/about/privacy/">Facebook</a>  basic account information, including your name, email, gender, birthday, current city, and profile picture URL, as well as other information that you choose to make public. We may also request access to other permissions related to your account, such as friends, check-ins, and likes, and you may choose to grant or deny us access to each individual permission. For more information regarding Facebook permissions, refer to the  <a href="https://developers.facebook.com/docs/facebook-login/permissions">Facebook Permissions Reference</a> page.<br /><br />

                    <b>Data From Social Networks</b> <br /><br />
                    ...
                    <b>Third-Party Data</b> <br /><br />
                    Information from third parties, such as personal information or network friends, if you connect your account to the third party and grant the Site permission to access this information.<br /><br />

                    <b> Data from Contests, Giveaways, and Surveys</b><br /><br />
                    Personal and other information you may provide when entering contests or giveaways and/or responding to surveys.<br /><br />

                    <b>Mobile Application Information</b> <br /><br />
                    If you connect using our mobile application:<br /><br />
                    ...
                    Mobile Device Data. We may collect device information (such as your mobile device ID, model and manufacturer), operating system, version information and IP address.<br />
                    Push Notifications. We may request to send you push notifications regarding your account or the Application. If you wish to opt-out from receiving these types of communications, you may turn them off in your device’s settings.<br /><br />

                    <b>USE OF YOUR INFORMATION</b><br /><br />
                    Having accurate information about you permits us to provide you with a smooth, efficient, and customized experience. Specifically, we may use information collected about you via the Site [or our mobile application] to:<br /><br />

                    Create and manage your account.<br />
                    Respond to product and customer service requests.<br />
                    Deliver targeted advertising, coupons, newsletters, and other information regarding promotions and the Site [and our mobile application] to you.<br />
                    Email you regarding your account or order.<br />
                    Enable user-to-user communications.<br />
                    Fulfill and manage purchases, orders, payments, and other transactions related to the Site [and our mobile application].<br />
                    ...
                    Notify you of updates to the Site [and our mobile applications].<br />
                    ...
                    Solicit support for the Site [and our mobile application].<br />
                    Compile anonymous statistical data and analysis for use internally or with third parties.<br /><br />


                    <b>DISCLOSURE OF YOUR INFORMATION</b> <br /><br />
                    ...
                    <br /><br />
                    <b>Third-Party Advertisers</b>  <br /><br />
                    ...
                    <br /><br />
                    <b>Business Partners</b> <br /><br />
                    We may share your information with our business partners to offer you certain products, services or promotions.
                    <br /><br />
                    <b>Social Media Contacts</b> <br /><br />
                    ...
                    <br /><br />
                    <b>Other Third Parties</b>  <br /><br />
                    We may share your information with advertisers and investors for the purpose of conducting general business analysis. We may also share your information with such third parties for marketing purposes, as permitted by law.
                    <br /><br />
                    <b>Sale or Bankruptcy</b> <br /><br />
                    ...
                    <br /><br />
                    <b>Internet-Based Advertising</b> <br /><br />
                    ...
                    <br /><br />
                    <b>Emails and Communications</b>  <br /><br />
                    ...
                    <br /><br />
                    Ario Entertainment UG <br />
                    Volksdorfer Grenzweg 38a <br />
                    22359 Hamburg <br />
                    Germany <br />
                    +49 176 60345223 <br />
                    info@arioentertainment.com <br />
